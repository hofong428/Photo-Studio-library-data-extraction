...
n_obj = {
    ...
    endian: function (e) {
        if (e.constructor == Number)
            return 16711935 & n_obj.rotl(e, 8) | 4278255360 & n_obj.rotl(e, 24);
        for (var t = 0; t < e.length; t++)
            e[t] = n_obj.endian(e[t]);
        return e
    },
...
_gg = function (e, t, n, r, i, a, o) {
        var s = e + (t & r | n & ~r) + (i >>> 0) + o;
        return (s << a | s >>> 32 - a) + t
    },
_hh = function (e, t, n, r, i, a, o) {
        var s = e + (t ^ n ^ r) + (i >>> 0) + o;
        return (s << a | s >>> 32 - a) + t
    },
_ii = function (e, t, n, r, i, a, o) {
        var s = e + (n ^ (t | ~r)) + (i >>> 0) + o;
        return (s << a | s >>> 32 - a) + t
    }
...
var n_123 = {
    utf8: {
        stringToBytes: function (e) {
            return n_123.bin.stringToBytes(unescape(encodeURIComponent(e)))
        },
        bytesToString: function (e) {
            return decodeURIComponent(escape(n_123.bin.bytesToString(e)))
        }
    },
    bin: {
        stringToBytes: function (e) {
...
o = function (e, n) {
    e.constructor == String ? e = n && "binary" === n.encoding ? a.stringToBytes(e) : n_123.utf8.stringToBytes(e) : i(e) ? e = Array.prototype.slice.call(e, 0) : Array.isArray(e) || e.constructor === Uint8Array || (e = e.toString());
    for (var s = n_obj.bytesToWords(e), c = 8 * e.length, u = 1732584193, l = -271733879, h = -1732584194, d = 271733878, f = 0; f < s.length; f++)
    ...
    return n_obj.endian([u, l, h, d])
};

d123 = function (e) {
    h = {}
    e._ts = (new Date).getTime() - 9999;
    var t, n = Object.keys(e), i = "", o = a123(n.sort());
    try {
        for (o.s(); !(t = o.n()).done;) {
            var a = t.value;
    ...
    h['Signature'] = exports123(i)
    h['param'] = e
    return h
}

exports123 = function (e, n) {
    if (void 0 === e || null === e)
        throw new Error("Illegal argument " + e);
    var r = n_obj.wordsToBytes(o(e, n));
    return n && n.asBytes ? r : n && n.asString ? a.bytesToString(r) : n_obj.bytesToHex(r)
}
